APPNP, ARGO, ARMA, BGNN, BGRL, CAPSULE, CAREGNN, CLUSTER_GCN, COMPGCN, CORRECT_AND_SMOOTH, DAGNN, DEEPERGNN, DEEPWALK, DGI, DGMG, DIFFPOOL, DIMENET, DTGRNN, EEG-GCNN, EGES, EVOLVEGCN, GAS, GAT, GATNE-T, GATV2, GCMC, GCN, GENIEPATH, GGNN, GIN, GNN_EXPLAINER, GRACE, GRAND, GRAPH_MATCHING, GRAPHSAINT, GRAPHSAGE, GRAPHSIM, GRAPHWRITER, GXN, 

HAN, HARDGAT, HGP_SL, HGT, HILANDER, INFOGRAPH, JKNET, JTNN, LABEL_PROPAGATION, LABOR, LDA, LINE_GRAPH, METAPATH2VEC, MIXHOP, MODEL_ZOO, MONET, MULTIGPU, MVGRL, NODE2VEC, OGB, OGB_LSC, OGC, P-GNN, PINSAGE, POINTCLOUD, RECT, RGAT, RGCN, RGCN-HETERO, RRN, SAGPOOL, SEAL, SGC, SIGN, STGCN_WAVE, TAHIN, TAGCN, TGN, TREE_LSTM, VGAE, VRGCN
